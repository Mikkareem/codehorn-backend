...
RUN chmod +x ./gradlew \
    ...
    && mv ./javascript-execution-service/build/libs/javascript-execution-service-1.0.0.jar ./javascript-execution-service.jar \
    && apt update \
    && apt install unzip -y \
    && unzip ./javascript-execution-service.jar -d temp
...
RUN $JAVA_HOME/bin/jdeps \
      ...
      ./javascript-execution-service.jar > ./jre-modules.txt \
    && $JAVA_HOME/bin/jlink \
      --verbose \
